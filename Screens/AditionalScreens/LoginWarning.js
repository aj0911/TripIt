  ...
  return (
    <LinearGradient style={AuthStyleSheet.mainView} colors={[Colors.mainCol,Colors.secCol]}>
        ...
        <View style={AuthStyleSheet.boxView}>
          ...
          <Text style={AuthStyleSheet.boxView.title}>User Need to login for access this screen</Text>
          <TouchableOpacity onPress={()=>navigation.navigate('Login')} style={AuthStyleSheet.boxView.btn}>
